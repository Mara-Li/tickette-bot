export default {
	...
	ping: {
		title: "ping",
		description: "Ping role after ticket creation",
		toggle: "Mention or not ",
		success: {
			false: "Role(s) won't be mentionned",
			true: "The role(s) will be mentionned",
		},
	},
	...
	error: {
		channel:
			"Error while editing the template: message not found.You need to use the command in the same channel the template JSON was saved.",
		...
		footer:
			"Error while editing the template: the embed footer is not in the good format.",
		field: {
			...
			tooMuch:
				"Error while editing the template: the template has too much fields. You can't have more than 5 fields.",
		},
		role: {
	...
	fields: {
		...
		name: {
			name: "field_id",
			description:
				"The id of the field, keep it short and simple. Use the field in the thread name with {{value}}",
		},
		remove: {
			name: "remove",
	...
	embed: {
		...
		edit: {
			...
			message_id: {
				name: "message_id",
				description:
					"The message ID of the embed. You need to use the command in the channel of the embed.",
			},
			channel: {
				name: "channel",
			...
			color: {
				name: "color",
				description:
					"Allow to changing the color. Hexadecimal value, rgb value, or via a color name",
			},
			thumbnail: {
				name: "thumbnail",
			...
			error: {
				...
				notFound:
					"The message was not found: you need to use the command in the embed's channel.",
				noEmbed: "The message has no embed",
				invalidColor:
					"The color is not valid. You must use a hexadecimal value, a rgb value (in the format `(1, 2, 3)` or `[1,2,3]`) or [a color name from this list](https://old.discordjs.dev/#/docs/discord.js/main/typedef/Colors)",
			},
			success: {
				jump: "Embed edited.\n[Jump to message]({{url}})",
				simple: "Embed edited",
		...
		resend: {
			...
			error: {
				textChannel: "This command can only be used in a text channel",
				notFound:
					"The message was not found: you need to use the command in the template's channel.",
