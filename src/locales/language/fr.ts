export default {
	...
	error: {
		channel:
			"Erreur lors de l'édition du template : message non trouvé. Vous devez utiliser la commande dans le même channel que le JSON du template.",
		attachment:
			"Erreur lors de l'édition du template : le message n'a pas de fichier joint.",
		footer:
			"Erreur lors de l'édition du template : le footer de l'embed n'a pas le bon format.",
		...
		field: {
			...
			tooMuch:
				"Erreur lors de l'édition du template : le template a trop de champs. Vous ne pouvez pas avoir plus de 5 champs.",
		},
		role: {
	...
	modal: {
		...
		description:
			"{{user}} a créé un nouveau ticket !\n Voici les informations fournies par l'utilisateur :",
	},
	ping: {
		title: "mention",
		description: "Mentionner le(s) rôle(s) après la création du ticket",
		toggle: "Mentionner ou non le(s) rôle(s)",
		success: {
			false: "Les role(s) ne seront pas mentionné(s)",
			true: "Le(s) role(s) seront mentionné(s)",
		},
	},
	new: {
		...
		thread_name: {
			name: "thread_name",
			description:
				"Le nom du thread. Les variables peuvent être transformée avec {{valeur}}",
		},
		role: {
	...
	fields: {
		...
		name: {
			name: "field_id",
			description:
				"L'id du champ, gardez-le court et simple. Utiliser le champ dans le nom du thread avec {{valeur}}",
		},
		remove: {
			name: "supprimer",
	...
	embed: {
		...
		edit: {
			...
			message_id: {
				name: "message_id",
				description:
					"L'ID du message de l'embed. Vous devez utiliser la commande dans le même channel que l'embed.",
			},
			channel: {
				name: "channel",
			...
			color: {
				name: "couleur",
				description:
					"La couleur de l'embed. Accepte des valeurs hexadecimal, rgb ou un nom de couleur",
			},
			thumbnail: {
				name: "thumbnail",
			...
			error: {
				...
				notFound:
					"Le message n'a pas été trouvé : vous devez utiliser la commande dans le même channel que l'embed.",
				noEmbed: "Le message n'a pas d'embed.",
				invalidColor:
					"La couleur n'est pas valide. Merci d'utiliser une valeur hexadécimal, un [nom de couleur depuis cette liste](https://old.discordjs.dev/#/docs/discord.js/main/typedef/Colors) ou une valeur rgb.",
			},
			success: {
